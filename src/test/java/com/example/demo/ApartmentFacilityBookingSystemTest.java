...
public class ApartmentFacilityBookingSystemTest {
    ...
    public void t14_createBooking() {
        ...
        // Mock bookingLogRepository.save
        when(bookingLogRepository.save(any(BookingLog.class))).thenAnswer(inv -> {
            BookingLog log = inv.getArgument(0);
            log.setId(1L);
            return log;
        });
        ...
        Assert.assertEquals(created.getId(), Long.valueOf(100L));
    }
